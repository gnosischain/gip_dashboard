...
const BarChartIcon = () => (
  ...
  const PieChartIcon = () => (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3V12H21Z" fill="currentColor" />
      <path d="M12 3C16.9706 3 21 7.02944 21 12H12V3Z" fill="currentColor" fillOpacity="0.5" />
    </svg>
  );
